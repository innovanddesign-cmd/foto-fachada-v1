...
export default function Home() {
 ...
 <footer className="studio-container flex flex-wrap justify-between gap-5 text-sm"><p>INNOVA AND DESIGN · Escaparates Digitales</p><div className="flex gap-5"><Link href="/legal/privacidad">Privacidad</Link><Link href="/legal/terminos">Términos</Link><Link href="/dashboard?seccion=ayuda">Ayuda</Link></div></footer>
 </main>;
}
