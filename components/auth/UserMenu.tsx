...
export function UserMenu() {
    ...
    if (!user) {
        return (
            <a
                href="/auth/login"
                className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/5 border border-white/10 text-white/60 hover:text-white hover:bg-white/10 transition-colors text-xs font-bold"
            >
    ...
    return (
        <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20">
                ...
                <span className="text-[10px] font-bold text-emerald-400">Sync</span>
            </div>
